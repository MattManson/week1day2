...
#
  ...
  def test_volume_of_cube()
    test_volume_of_cube_result = volume_of_cube( 4 )
    assert_equal( 64, test_volume_of_cube_result )
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    test_volume_of_sphere_result = volume_of_sphere (3)
    assert_equal( 113.04, test_volume_of_sphere_result)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    test_fahrenheit_to_celsius_result = farenheit_to_celcius(86)
    assert_equal( 30, test_fahrenheit_to_celsius_result)
  end
